...
struct TotalDataView: View {
    ...
    var body: some View {
        ...
        VStack {
            HStack {
                TotalDataCard(number: totalData.confirmed.formatNumber(), name: "Confirmed", color: .primary)
            ...
            HStack {
                ...
                TotalDataCard(number: String(format: "%.2f", totalData.revoveredRate), name: "Recovery %", color: .green)
            }
        }// End of VStack
        .frame(height: 170)
        .padding(10)
